    ...
    public partial class NewCustomer : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                con.Close();
                con.Open();
                StrSql = "insert into MyOrder(Date,CustomerName,Contact,Nettotal,sgstr,cgstr,igstr,sgsta,cgsta,igsta,GrandTotal,Advance,Balance) values  ( @Date,@CustomerName,@Contact,@Nettotal,@sgstr,@cgstr,@igstr,@sgsta,@cgsta,@igsta,@GrandTotal,@Advance,@Balance)";
                ...
                da = new SqlDataAdapter("select * from MyOrder where CustomerName='" + textBox1.Text + "' ", con);
                da.Fill(dt);
        ...
        private void button5_Click_1(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                StrSql = "update machineinfo Set AvaliableStock=@AvaliableStock where Ltr='" + untltr.Text + "'";
                // StrSql = "insert into order values";
                SqlCommand cmd = new SqlCommand(StrSql, con);
        ...
        private void button1_Click_1(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                con.Close();
                con.Open();
                StrSql = "insert into MyOrder(Date,CustomerName,Contact,Nettotal,sgstr,cgstr,igstr,sgsta,cgsta,igsta,GrandTotal,Bal,GSTIN,HSN,OrderNo,OD,Word,Dis,DisR,NewT,Paid) values  ( @Date,@CustomerName,@Contact,@Nettotal,@sgstr,@cgstr,@igstr,@sgsta,@cgsta,@igsta,@GrandTotal,@Bal,@GSTIN,@HSN,@OrderNo,@OD,@Word,@Dis,@DisR,@NewT,@Paid)";
                // StrSql = "insert into order values";
                SqlCommand cmd = new SqlCommand(StrSql, con);
                cmd.Parameters.AddWithValue("@CustomerName", textBox1.Text);
                cmd.Parameters.AddWithValue("@Date", date.Text);
                ...
                //cmd.Parameters.AddWithValue("@igsta", textBox14.Text);
                cmd.Parameters.AddWithValue("@GrandTotal", textBox11.Text);
                cmd.Parameters.AddWithValue("@Paid", textBox15.Text);
                cmd.Parameters.AddWithValue("@Bal", textBox16.Text);
            ...
            try
            {
                ...
                con.Open();
                // StrSql = "insert into MyOrder(CustomerName,Date,Contact,ProductName,Can,Qty,Amount,Total) values  (@CustomerName,@Date,@Contact,@ProductName,@Can,@Qty,@Amount,@Total)";
                StrSql = "update MyOrder Set Paid=@Paid,Bal=@Bal Where OrderNo='" + textBox21.Text + "'AND GrandTotal != 0";
                // StrSql = "insert into order values";
                SqlCommand cmd = new SqlCommand(StrSql, con);
                cmd.Parameters.AddWithValue("@Paid", textBox15.Text);
                cmd.Parameters.AddWithValue("@Bal", textBox16.Text);
        ...
        private void untltr_SelectedIndexChanged_1(object sender, EventArgs e)
        {
            //try
            //{
            //    StrSql = ConfigurationManager.ConnectionStrings["ConStr"].ConnectionString;
